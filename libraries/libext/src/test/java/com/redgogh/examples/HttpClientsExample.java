...
import com.redgogh.libext.http.FormBodyBuilder;
import com.redgogh.libext.http.HttpClients;
...
public class HttpClientsExample {
    ...
    public void callFormBodyExample() {
        ...
        formBodyBuilder.put("document", new File("src/main/java/com/redgogh/libext/ArrayUtils.java"));
