...
import com.redgogh.jdkext.http.FormBodyBuilder;
import com.redgogh.jdkext.http.HttpClients;
...
public class HttpClientsExample {
    ...
    public void callFormBodyExample() {
        ...
        formBodyBuilder.put("document", new File("src/main/java/com/redgogh/jdkext/ArrayUtils.java"));
