package org.redgogh.commons.http;
...
import static org.redgogh.commons.string.StringUtils.strcount;
...
public class HttpClient {
     ...
     */
    public org.redgogh.commons.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public org.redgogh.commons.http.Response newCall(org.redgogh.commons.http.Callback callback) {
    ...
    private okhttp3.Response newCall0(Object callback) throws IOException {
        ...
        /* async */
        if (callback != null) {
            if (callback instanceof org.redgogh.commons.http.Callback)
    ...
    private RequestBody getRequestBody() {
        ...
        /* is MultipartBody. */
        if (object instanceof org.redgogh.commons.http.MultipartBody) {
            org.redgogh.commons.http.MultipartBody multipartBody = (org.redgogh.commons.http.MultipartBody) object;
     ...
     * 处理响应
     */
    private org.redgogh.commons.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        org.redgogh.commons.http.Response retval = new org.redgogh.commons.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
    ...
    private void async(Call call, org.redgogh.commons.http.Callback callback) {
