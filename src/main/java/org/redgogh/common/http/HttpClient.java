package org.redgogh.common.http;
...
import org.redgogh.common.base.*;
import org.redgogh.common.collect.Maps;
import org.redgogh.common.exception.HttpRequestException;
import org.redgogh.common.base.Assert;
import org.redgogh.common.base.Capturer;
import org.redgogh.common.base.Optional;
import org.redgogh.common.io.MutableFile;
import okhttp3.*;
import org.jetbrains.annotations.NotNull;
import org.redgogh.common.string.StringUtils;

import java.io.IOException;
import java.util.Map;
import java.util.concurrent.TimeUnit;

import static org.redgogh.common.string.StringUtils.strcount;
...
public class HttpClient {
     ...
     */
    public org.redgogh.common.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public org.redgogh.common.http.Response newCall(org.redgogh.common.http.Callback callback) {
    ...
    private okhttp3.Response newCall0(Object callback) throws IOException {
        ...
        /* async */
        if (callback != null) {
            if (callback instanceof org.redgogh.common.http.Callback)
    ...
    private RequestBody getRequestBody() {
        ...
        /* is MultipartBody. */
        if (object instanceof org.redgogh.common.http.MultipartBody) {
            org.redgogh.common.http.MultipartBody multipartBody = (org.redgogh.common.http.MultipartBody) object;
     ...
     * 处理响应
     */
    private org.redgogh.common.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        org.redgogh.common.http.Response retval = new org.redgogh.common.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
    ...
    private void async(Call call, org.redgogh.common.http.Callback callback) {
