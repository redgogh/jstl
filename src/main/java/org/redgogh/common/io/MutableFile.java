...
import org.redgogh.common.os.OSEnvironment;
...
import static org.redgogh.common.string.StringUtils.*;
...
public class MutableFile extends java.io.File {
    ...
    public boolean typeMatch(String... extensions) {
        return strcount(getExtension(), extensions);
    }
