...
public class HttpClient {
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response get(String url) {
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response get(String url, QueryArgumentsBuilder builder) {
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response get(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response get(String url, RequestConfigure configure, QueryArgumentsBuilder builder) {
        return open("GET", url)
                .configure(configure)
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response post(String url) {
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response post(String url, Object body) {
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response post(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.karasuba.http.Response post(String url, RequestConfigure configure, Object body) {
     ...
     */
    public org.karasuba.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public org.karasuba.http.Response newCall(Callback callback) {
     ...
     * 处理响应
     */
    private org.karasuba.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        org.karasuba.http.Response retval = new org.karasuba.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
