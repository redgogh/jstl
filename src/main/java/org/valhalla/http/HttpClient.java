...
import org.valhalla.collection.Maps;
import org.valhalla.exception.HttpRequestException;
...
import static org.valhalla.string.StringUtils.strcheckin;
...
public class HttpClient {
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response get(String url) {
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response get(String url, QueryArgumentsBuilder builder) {
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response get(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response get(String url, RequestConfigure configure, QueryArgumentsBuilder builder) {
        return open("GET", url)
                .configure(configure)
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response post(String url) {
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response post(String url, Object body) {
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response post(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.valhalla.http.Response post(String url, RequestConfigure configure, Object body) {
     ...
     */
    public org.valhalla.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public org.valhalla.http.Response newCall(Callback callback) {
     ...
     * 处理响应
     */
    private org.valhalla.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        org.valhalla.http.Response retval = new org.valhalla.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
