...
import org.veronica.exception.HttpRequestException;
...
import static org.veronica.string.StringUtils.strcheckin;
...
public class HttpClient {
     ...
     * @return 响应
     */
    public static org.veronica.http.Response get(String url) {
     ...
     * @return 响应
     */
    public static org.veronica.http.Response get(String url, QueryArgumentsBuilder builder) {
     ...
     * @return 响应
     */
    public static org.veronica.http.Response get(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.veronica.http.Response get(String url, RequestConfigure configure, QueryArgumentsBuilder builder) {
        return open("GET", url)
                .configure(configure)
     ...
     * @return 响应
     */
    public static org.veronica.http.Response post(String url) {
     ...
     * @return 响应
     */
    public static org.veronica.http.Response post(String url, Object body) {
     ...
     * @return 响应
     */
    public static org.veronica.http.Response post(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.veronica.http.Response post(String url, RequestConfigure configure, Object body) {
     ...
     */
    public org.veronica.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public org.veronica.http.Response newCall(Callback callback) {
     ...
     * 处理响应
     */
    private org.veronica.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        org.veronica.http.Response retval = new org.veronica.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
