package com.redgogh.jstl.security;
...
import com.redgogh.jstl.security.codec.Base64Codec;
import com.redgogh.jstl.security.codec.MD5Codec;
import com.redgogh.jstl.security.codec.SHA256Codec;
import com.redgogh.jstl.security.codec.URLCodec;
import com.redgogh.jstl.string.StringUtils;
import com.redgogh.jstl.utils.Capturer;
import com.redgogh.jstl.string.StringExtensionsInterface;
...
public class Codec {
    ...
    public static String toByteHex(byte[] bytes) {
        ...
        return atos(builder, StringExtensionsInterface.STRING_IFACE_UPPER_CASE_EXT);
    }
