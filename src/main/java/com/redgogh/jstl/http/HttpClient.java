...
import com.redgogh.jstl.exception.HttpRequestException;
...
public class HttpClient {
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response get(String url) {
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response get(String url, QueryArgumentsBuilder builder) {
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response get(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response get(String url, RequestConfigure configure, QueryArgumentsBuilder builder) {
        return open("GET", url)
                .configure(configure)
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response post(String url) {
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response post(String url, Object body) {
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response post(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static com.redgogh.jstl.http.Response post(String url, RequestConfigure configure, Object body) {
     ...
     */
    public com.redgogh.jstl.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public com.redgogh.jstl.http.Response newCall(Callback callback) {
     ...
     * 处理响应
     */
    private com.redgogh.jstl.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        com.redgogh.jstl.http.Response retval = new com.redgogh.jstl.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
