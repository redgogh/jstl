...
import com.redgogh.commons.lang3.exception.HttpRequestException;
...
public class HttpClient {
     ...
     */
    public com.redgogh.commons.lang3.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public com.redgogh.commons.lang3.http.Response newCall(com.redgogh.commons.lang3.http.Callback callback) {
    ...
    private okhttp3.Response newCall0(Object callback) throws IOException {
        ...
        /* async */
        if (callback != null) {
            if (callback instanceof com.redgogh.commons.lang3.http.Callback)
    ...
    private RequestBody getRequestBody() {
        ...
        /* is MultipartBody. */
        if (object instanceof com.redgogh.commons.lang3.http.MultipartBody) {
            com.redgogh.commons.lang3.http.MultipartBody multipartBody = (com.redgogh.commons.lang3.http.MultipartBody) object;
     ...
     * 处理响应
     */
    private com.redgogh.commons.lang3.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
    ...
    private void async(Call call, com.redgogh.commons.lang3.http.Callback callback) {
